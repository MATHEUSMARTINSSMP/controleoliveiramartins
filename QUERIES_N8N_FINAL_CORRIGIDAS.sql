-- ============================================================================
-- QUERIES SQL FINAIS CORRETAS PARA O WORKFLOW N8N
-- ============================================================================
-- Schema: sistemaretiradas
-- Todas as queries corrigidas e prontas para copiar e colar
-- ============================================================================
...
-- Busca o admin_token (GLOBAL) da tabela uazapi_config
...
-- ============================================================================
-- 2. POSTGRESQL - GET TOKEN (CORRIGIDA!)
-- ============================================================================
-- Node: "PostgreSQL - Get Token"
-- Busca credenciais da instância WhatsApp (POR LOJA)
--
...
-- Salva ou atualiza credenciais WhatsApp
...
-- ============================================================================
-- 1. Schema: elevea → sistemaretiradas ✅
-- 2. Query Get Token: Removido uazapi_admin_token (não existe na tabela) ✅
-- ============================================================================
