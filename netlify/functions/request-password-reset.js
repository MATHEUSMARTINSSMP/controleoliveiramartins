                    ...
                    <tr>
                      <td style="padding: 40px 40px;">
                        ...
                        <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 20px 0;">
                          Faça login em: <a href="https://eleveaone.com.br/auth" style="color: #2563eb; text-decoration: none; font-weight: 600;">Sistema EleveaOne</a>
                        </p>
                        
                        <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 8px; padding: 16px; margin: 20px 0;">
                          <p style="color: #92400e; font-size: 14px; line-height: 1.6; margin: 0;">
                            <strong>Importante:</strong> Por favor, altere sua senha após fazer login.
                          </p>
                        </div>
