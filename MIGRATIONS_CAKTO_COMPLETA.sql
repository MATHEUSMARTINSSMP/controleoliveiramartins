...
-- ============================================================================
-- PARTE 5: ADICIONAR COLUNA updated_at (se não existir)
-- ============================================================================
-- Adiciona coluna updated_at para compatibilidade com funções/triggers existentes
ALTER TABLE sistemaretiradas.admin_subscriptions
...
COMMENT ON COLUMN sistemaretiradas.admin_subscriptions.updated_at IS 'Data da última atualização (atualizada automaticamente por trigger)';
