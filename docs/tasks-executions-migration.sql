...
-- 6. Função para marcar tarefa como concluída
...
BEGIN
    ...
    VALUES (
        p_task_id, p_store_id, p_date, TRUE, NOW(), p_completed_by, p_notes
    )
...
-- 7. Função para desmarcar tarefa
...
BEGIN
    ...
    SET is_completed = FALSE,
        ...
        completed_by = NULL,
        updated_at = NOW()
    WHERE task_id = p_task_id AND execution_date = p_date;
