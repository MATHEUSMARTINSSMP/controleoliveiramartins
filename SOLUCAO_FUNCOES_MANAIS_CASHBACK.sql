-- ============================================================================
-- ✅ SOLUÇÃO: CRIAR FUNÇÕES RPC PARA OPERAÇÕES MANUAIS DE CASHBACK
-- ============================================================================
-- Execute esta query no Supabase SQL Editor para criar as funções que estão faltando
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION sistemaretiradas.lancar_cashback_manual(UUID, NUMERIC, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION sistemaretiradas.lancar_cashback_manual(UUID, NUMERIC, TEXT) TO anon;
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION sistemaretiradas.resgatar_cashback_manual(UUID, NUMERIC, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION sistemaretiradas.resgatar_cashback_manual(UUID, NUMERIC, TEXT) TO anon;
