...
COMMENT ON FUNCTION sistemaretiradas.send_time_clock_notification() IS 'Adiciona notificação de ponto à fila com mensagem formatada - Versão melhorada com formatação aprimorada';
