-- ============================================================================
-- VERSÃO FINAL: processar_tiny_order_para_venda FUNCIONANDO
-- ============================================================================
-- Data: 2025-12-24
-- Descrição: Versão final que funciona corretamente, retornando NULL silenciosamente
--            em caso de erro (não re-lança erro para não quebrar o processo)
-- ============================================================================
...
VERSÃO FINAL: Usa apenas colunas essenciais, retorna NULL silenciosamente em caso de erro.
O trigger defensivo permite que vendas sejam criadas mesmo se a linkagem automática falhar.';

-- ============================================================================
-- ✅ FUNÇÃO FINAL APLICADA
-- ============================================================================
