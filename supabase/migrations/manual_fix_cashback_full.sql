-- ============================================================================
-- SCRIPT DE CORREÇÃO MANUAL - CASHBACK
-- Execute este script COMPLETO no SQL Editor do Supabase
-- ============================================================================

BEGIN;

-- 1. Alterar tabela cashback_transactions (Adicionar sale_id)
...
-- 2. Remover FK estrita de cliente_id em cashback_transactions
DO $$
BEGIN
    IF EXISTS (
...
-- 3. Remover FK estrita de cliente_id em cashback_balance
DO $$
BEGIN
    IF EXISTS (
        SELECT 1 FROM pg_constraint 
...
-- 4. Remover FK estrita de cliente_id em cashback_whatsapp_queue
DO $$
BEGIN
    IF EXISTS (
        SELECT 1 FROM pg_constraint 
...
-- 5. Atualizar função enqueue_cashback_whatsapp
...
-- 6. Atualizar função gerar_cashback (Versão Final com sale_id e enqueue)
...
-- 7. Criar Trigger na tabela SALES
...
-- 8. Remover Trigger antigo da tabela tiny_orders
DROP TRIGGER IF EXISTS trg_gerar_cashback_new_order ON sistemaretiradas.tiny_orders;

COMMIT;

RAISE NOTICE '✅ ATUALIZAÇÃO MANUAL CONCLUÍDA COM SUCESSO!';
