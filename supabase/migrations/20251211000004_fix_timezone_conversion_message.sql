-- =====================================================
-- CORRIGIR CONVERSÃO DE TIMEZONE NA MENSAGEM DE NOTIFICAÇÃO
-- =====================================================
-- O problema: está fazendo AT TIME ZONE 'UTC' AT TIME ZONE 'America/Belem'
-- Se o campo já está em TIMESTAMP WITH TIME ZONE, só precisa converter uma vez
...
BEGIN
    ...
    -- CORRIGIR: Converter diretamente para Belém (UTC-3)
    -- NEW.horario já é TIMESTAMP WITH TIME ZONE, então só precisa converter uma vez
...
COMMENT ON FUNCTION sistemaretiradas.send_time_clock_notification() IS 'Adiciona notificação de ponto à fila com mensagem formatada - Timezone corrigido (conversão única para Belém)';
