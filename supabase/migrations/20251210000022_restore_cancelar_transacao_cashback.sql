-- =====================================================
-- RESTAURAR FUNÇÃO: cancelar_transacao_cashback
-- =====================================================
-- Esta função é usada no frontend (CashbackManagement.tsx)
-- e precisa ser restaurada se não existir
...
COMMENT ON FUNCTION sistemaretiradas.cancelar_transacao_cashback IS 'Cancela uma transação de cashback criando um ajuste inverso. Usada no frontend (CashbackManagement.tsx)';

-- Conceder permissões de execução
GRANT EXECUTE ON FUNCTION sistemaretiradas.cancelar_transacao_cashback(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION sistemaretiradas.cancelar_transacao_cashback(UUID) TO anon;
