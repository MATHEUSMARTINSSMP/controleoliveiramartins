...
import { Save, Webhook, Loader2, CheckCircle2, AlertCircle } from "lucide-react";
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="auth-webhook-url">
          ...
          <div className="space-y-2">
            <Label htmlFor="send-webhook-url">
          ...
          <div className="space-y-2">
            <Label htmlFor="n8n-auth-key">
              Chave de Autenticação n8n (X-APP-KEY)
            </Label>
            <Input
              id="n8n-auth-key"
              type="password"
              placeholder="Token de autenticação do webhook n8n"
              value={config.n8n_webhook_auth || ''}
        ...
        <div className="mt-4 p-4 bg-muted/50 rounded-lg">
          ...
          <ul className="text-xs text-muted-foreground space-y-1">
            ...
            <li>• Estas configurações são específicas para cada admin</li>
          </ul>
        </div>
      </CardContent>
    </Card>
