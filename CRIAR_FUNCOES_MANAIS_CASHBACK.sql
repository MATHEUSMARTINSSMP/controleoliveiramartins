-- ============================================================================
-- ✅ CRIAR/ATUALIZAR FUNÇÕES RPC PARA OPERAÇÕES MANUAIS DE CASHBACK
-- ============================================================================
-- Execute esta query no Supabase SQL Editor para garantir que as funções
-- de lançamento e resgate manual de cashback existam e funcionem
...
BEGIN
    ...
    -- Calcular valor do cashback baseado no percentual configurado
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION sistemaretiradas.lancar_cashback_manual TO authenticated;
GRANT EXECUTE ON FUNCTION sistemaretiradas.lancar_cashback_manual TO anon;
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION sistemaretiradas.resgatar_cashback_manual TO authenticated;
GRANT EXECUTE ON FUNCTION sistemaretiradas.resgatar_cashback_manual TO anon;
...
WHERE routine_schema = 'sistemaretiradas'
  AND routine_name IN ('lancar_cashback_manual', 'resgatar_cashback_manual')
ORDER BY routine_name;

-- ============================================================================
-- 4. RECARREGAR SCHEMA CACHE DO POSTGREST (se necessário)
-- ============================================================================
-- Nota: O PostgREST pode precisar ser reiniciado para recarregar o cache
-- Se as funções ainda não aparecerem, pode ser necessário reiniciar o Supabase
